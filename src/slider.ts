...
let Slider: new (f: any, options: any) => any = L.Control.extend({
    ...
    options: {
        ...
        increment: false,
        getValue: function(value: number) {
            return value;
        },
        showValue: true,
        syncSlider: false
    },
    initialize: function (f: any, options: any) {
        L.setOptions(this, options);
        if (typeof f == "function") {
            this.update = f;
        } else {
            this.update = function (value: any) {
                console.log(value);
            };
        }
        if (typeof this.options.getValue != "function") {
            this.options.getValue = function (value: any) {
                return value;
            };
        }
...
export default function makeSlider(f: any, options: any) {
    return new Slider(f, options);
}