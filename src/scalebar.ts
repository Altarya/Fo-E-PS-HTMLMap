...
let BetterScale: new (options: any) => any = L.Control.extend({
    ...
    onAdd: function (t: { on: (arg0: string, arg1: any, arg2: any) => any; whenReady: (arg0: any, arg1: any) => any }) {
        this._map = t
    ...
    onRemove: function (t: { off: (arg0: string, arg1: any, arg2: any) => void }) {
        t.off(this.options.updateWhenIdle ? "moveend" : "move", this._update, this)
    },
    _addScales: function (t: any, e: string, i: HTMLElement) {
    ...
    _updateScales: function (t: { metric: any; imperial: any }, e: any) {
        t.metric && e && this._updateMetric(e), t.imperial && e && this._updateImperial(e)
    },
    _updateMetric_old: function (t: number) {
        var e = this._getRoundNum(t)
        this._iScale.style.width = this._getScaleWidth(e / t) + "px", this._iScaleLabel.innerHTML = 1e3 > e ? e + " m" : e / 1e3 + " km"
    },
    _updateMetric: function (t: any) {
        var e, i, n, o, s, a = t,
    ...
    _updateImperial: function (t: number) {
    ...
    _getScaleWidth: function (t: number) {
        return Math.round(this.options.maxWidth * t) - 10
    },
    _getRoundNum: function (t: number) {
        if (t >= 2) {
...
export default function betterscale(options: any) {
    return new BetterScale(options)
}